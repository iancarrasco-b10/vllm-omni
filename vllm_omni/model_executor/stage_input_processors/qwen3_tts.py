...
def talker2code2wav_async_chunk(
    ...
    # Embed ctx_frames as the first element of code_predictor_codes so the
    # Code2Wav model can read it from input_ids without needing out-of-band
    # runtime_additional_information support from the framework.
    return {
